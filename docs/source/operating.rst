...
Generated On: 2024-09-25 00:57:35 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=34505  \-\-env VIPERVIZPORT=49153  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:49153/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:49153/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 41035:41035 -p 54535:54535 -p 41977:41977 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypi.git \-\-env SOLUTIONEXTERNALPORT=41035  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=54535  \-\-env SOLUTIONVIPERVIZPORT=41977 \-\-env DOCKERUSERNAME='maadsdocker' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=34505 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=49153 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/cybersecuritywithprivategpt-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=41977
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=41035
...
It can be accessed by entering: http://localhost:54535
...
.. important::
   http://localhost:41977/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:41977/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:41977/<html file>
...
.. important::
   https://github.com/smaurice101/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=41035, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=40337, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=33659, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45891, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36461, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46857, HPDEHOST=127.0.1.1, HPDEPORT=43573, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=35481

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7499-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-7927-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-4376-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
