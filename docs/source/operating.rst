...
.. code-block::
   ...
   docker run -d -p 46127:46127 -p 48647:48647 -p 35699:35699 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=46127 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=48647 \
          --env SOLUTIONVIPERVIZPORT=35699 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=46127, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=39115, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=37723, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=34531, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=39757, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=32807, HPDEHOST=127.0.1.1, HPDEPORT=39685, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44349

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8928-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-1003-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-2772-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
