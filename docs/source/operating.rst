...
.. code-block::
   ...
   docker run -d -p 35101:35101 -p 43999:43999 -p 42605:42605 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=35101 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=43999 \
          --env SOLUTIONVIPERVIZPORT=42605 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=35101, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=42343, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=43969, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46007, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=43111, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=36285, HPDEHOST=127.0.1.1, HPDEPORT=36649, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44869

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-1183-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-4794-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-4046-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
