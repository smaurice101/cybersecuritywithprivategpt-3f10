...
.. code-block::
   ...
   docker run -d -p 59021:59021 -p 60301:60301 -p 35137:35137 -p 8883:8883 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=59021 \
          -v /var/run/docker.sock:/var/run/docker.sock:z  \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=60301  \
          --env SOLUTIONVIPERVIZPORT=35137 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=59021, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=34547, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=38865, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=38497, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=32963, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=46099, HPDEHOST=127.0.1.1, HPDEPORT=35555, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42475

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-8437-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-8611-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-7772-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
