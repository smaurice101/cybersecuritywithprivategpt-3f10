...
Generated On: 2024-10-22 16:14:59 UTC
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=37247  \-\-env VIPERVIZPORT=43419  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:43419/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:43419/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 45971:45971 -p 52965:52965 -p 56199:56199 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=45971  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=52965  \-\-env SOLUTIONVIPERVIZPORT=56199 \-\-env DOCKERUSERNAME='maadsdocker' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=37247 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=43419 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/cybersecuritywithprivategpt-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=56199
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=45971
...
It can be accessed by entering: http://localhost:52965
...
.. important::
   http://localhost:56199/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:56199/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:56199/<html file>
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=45971, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=34245, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36309, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=45453, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=45073, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=45733, HPDEHOST=127.0.1.1, HPDEPORT=41101, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=44011

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-6670-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-3463-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-862-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
