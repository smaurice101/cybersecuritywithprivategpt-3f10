...
.. code-block::
   ...
   docker run -d -p 54881:54881 -p 41511:41511 -p 57263:57263 \
          --env TSS=0 \
          ...
          --env SOLUTIONEXTERNALPORT=54881 \
          -v /var/run/docker.sock:/var/run/docker.sock:z \
          --env CHIP=amd64 \
          --env SOLUTIONAIRFLOWPORT=41511 \
          --env SOLUTIONVIPERVIZPORT=57263 \
...
.. important::
   VIPERHOST_PRODUCE=0.0.0.0, VIPERPORT_PRODUCE=54881, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44757, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36879, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=46189, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36375, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41737, HPDEHOST=127.0.1.1, HPDEPORT=42363, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=45835

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2819-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-preprocess-8803-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, python-ai-2374-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_mqtt_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
