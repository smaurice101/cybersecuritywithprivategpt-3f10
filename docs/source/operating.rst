[cybersecuritywithprivategpt-3f10] Operating Details
====================================

Generated On: 2024-10-18 15:16:25 UTC
...
.. important::
   ...
   **not be valid if your [cybersecuritywithprivategpt-3f10] container is NOT running**.

.. tip::
   You must have your [cybersecuritywithprivategpt-3f10] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=36657  \-\-env VIPERVIZPORT=48621  \-\-env GITUSERNAME='smaurice101'  \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:48621/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:48621/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   maadsdocker/cybersecuritywithprivategpt-3f10-amd64 (https://hub.docker.com/r/maadsdocker/cybersecuritywithprivategpt-3f10-amd64)
...
.. important::
   docker run -d -p 33311:33311 -p 36589:36589 -p 55227:55227 \-\-env TSS=0 \-\-env SOLUTIONNAME=cybersecuritywithprivategpt-3f10 \-\-env SOLUTIONDAG=solution_preprocessing_ai_dag-cybersecuritywithprivategpt-3f10 \-\-env GITUSERNAME=smaurice101  \-\-env GITREPOURL=https://github.com/smaurice101/raspberrypitss.git \-\-env SOLUTIONEXTERNALPORT=33311  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=36589  \-\-env SOLUTIONVIPERVIZPORT=55227 \-\-env DOCKERUSERNAME='maadsdocker'  \-\-env EXTERNALPORT=36657 \-\-env KAFKACLOUDUSERNAME='MUHRHBPKJYPROKBX'  \-\-env VIPERVIZPORT=48621 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  maadsdocker/cybersecuritywithprivategpt-3f10-amd64
...
.. list-table::
   ...
   * - \-\-env  SOLUTIONVIPERVIZPORT=55227
   ...
   * - \-\-env SOLUTIONEXTERNALPORT=33311
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - maadsdocker/cybersecuritywithprivategpt-3f10-amd64
...
It can be accessed by entering: http://localhost:36589
...
.. important::
   http://localhost:55227/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:55227/viperlogs.html?topic=viperlogs&append=0
...
.. list-table::
   ...
   * - **Parameter**
     - **Explanation**
   * - http://localhost:55227/<html file>
...
[cybersecuritywithprivategpt-3f10] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/smaurice101/raspberrypitss/tree/main/tml-airflow/dags/tml-solutions/cybersecuritywithprivategpt-3f10
...
.. important::
   https://cybersecuritywithprivategpt-3f10.readthedocs.io
...
.. important::
   solution_preprocessing_ai_dag-cybersecuritywithprivategpt-3f10
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=33311, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=44143, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=40427, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=36901, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=32783, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=39287, HPDEHOST=127.0.1.1, HPDEPORT=34011, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=42399

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-2202-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-3f10, python-preprocess-5568-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-3f10, python-ai-9041-cybersecuritywithprivategpt-3f10,solution_preprocessing_ai_dag-cybersecuritywithprivategpt-3f10, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
