Scaling [cybersecuritywithprivategpt-3f10] With Kubernetes
===========================
...
Based on your TML solution [cybersecuritywithprivategpt-3f10] - if you want to scale your application with Kubernetes - you will need to apply the following YAML files.

.. list-table::

   * - **YML File**
     - **Description**
   * - :ref:`cybersecuritywithprivategpt-3f10.yml`
   ...
   * - :ref:`qdrant.yml`
     - This is the Qdrant deployment YAML.
       ...
       applied if using Step 9 DAG.
   * - :ref:`nginx-ingress-cybersecuritywithprivategpt-3f10.yml`
     - If you are scaling your TML solution you must

       apply the nginx-ingresscybersecuritywithprivategpt-3f10.yml; this yaml is 
...
.. code-block:: YAML
   ...
   kubectl apply -f kafka.yml -f secrets.yml -f mysql-storage.yml -f mysql-db-deployment.yml -f qdrant.yml -f privategpt.yml -f cybersecuritywithprivategpt-3f10.yml

cybersecuritywithprivategpt-3f10.yml
------------------------

.. important::
   Copy and Paste this YAML file: cybersecuritywithprivategpt-3f10.yml - and save it locally.
...
.. code-block:: YAML
   ...
   ################# cybersecuritywithprivategpt-3f10.yml
     ...
     kind: Deployment
     metadata:
       name: cybersecuritywithprivategpt-3f10
     spec:
       selector:
         matchLabels:
           app: cybersecuritywithprivategpt-3f10
       ...
       template:
         ...
         spec:
           containers:
           - name: cybersecuritywithprivategpt-3f10
             image: maadsdocker/cybersecuritywithprivategpt-3f10-amd64:latest
             volumeMounts:
             - name: dockerpath
   ...
   ---
     ...
     kind: Service
     metadata:
       name: cybersecuritywithprivategpt-3f10-visualization-service
       labels:
         app: cybersecuritywithprivategpt-3f10-visualization-service
     spec:
       type: ClusterIP
       ports:
...
.. code-block::
   ...
   kubectl port-forward deployment/cybersecuritywithprivategpt-3f10 42605:42605

After you forward the ports then copy/paste the viusalization URL below and run your dashboard.

.. code-block::

   http://localhost:42605/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   ...
   **STEP 4:  Apply nginx-ingress-cybersecuritywithprivategpt-3f10.yml to your kubernetes cluster.  First you need to save it locally then apply it:**

nginx-ingress-cybersecuritywithprivategpt-3f10.yml
-------------
   ...
   .. code-block::
      ...
      kubectl apply -f nginx-ingress-cybersecuritywithprivategpt-3f10.yml
